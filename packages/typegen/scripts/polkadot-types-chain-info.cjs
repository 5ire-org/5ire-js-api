...
try {
  ...
  require('@babel/register')({
    ...
    plugins: [
      ['module-resolver', {
        alias: {
          '^@5ire/api-derive(.*)': './packages/api-derive/src\\1',
          '^@5ire/api(.*)': './packages/api/src/\\1',
          '^@5ire/rpc-core(.*)': './packages/rpc-core/src\\1',
          '^@5ire/rpc-provider(.*)': './packages/rpc-provider/src\\1',
